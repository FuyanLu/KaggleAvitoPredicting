...
def rowToVec(row):
    ...
    vec=hisclickVec+paraVec+timeVec+categoryVec+searchlclvVec+positionVec
    return vec
...
with open('C:\\Users\\Fuyan\\Desktop\\avito-context-ad-clicks\\extended.csv', newline='') as f:
    ...
    np.savetxt(newtext,arraydata,fmt='%.4f\t'*2+'%d\t'*42+'%d',delimiter='\t',newline='\r\n')
    newtext.close()    
